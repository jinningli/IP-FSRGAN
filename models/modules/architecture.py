...
#         #     act_type=act_type, mode=mode)
#         # 32, 3
#         conv4 = B.conv_block(in_nc, base_nf, kernel_size=3, stride=1, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         conv5 = B.conv_block(base_nf, base_nf, kernel_size=4, stride=2, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         # 16, 64
#         conv6 = B.conv_block(base_nf, base_nf*2, kernel_size=3, stride=1, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         conv7 = B.conv_block(base_nf*2, base_nf*2, kernel_size=4, stride=2, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         # 8, 128
#         conv8 = B.conv_block(base_nf*2, base_nf*4, kernel_size=3, stride=1, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         conv9 = B.conv_block(base_nf*4, base_nf*4, kernel_size=4, stride=2, norm_type=norm_type, \
#             act_type=act_type, mode=mode)
#         # 4, 256
#         self.features = B.sequential(conv4, conv5, conv6, conv7, conv8,\
#             conv9)
#
#         # classifier
